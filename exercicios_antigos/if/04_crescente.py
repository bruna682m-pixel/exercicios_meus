...
if numero1 <= numero2:
    maior = numero2
    print("Seus números em ordem crescente ficam", numero1,"e", maior)
    print("Seus números em ordem decrescente ficam", maior,"e", numero1)
elif numero1 >= numero2:
    menor = numero2
    print("Seus números em ordem crescente ficam", menor,"e", numero1)
    print("Seus números em ordem decrescente ficam", numero1,"e", menor)
